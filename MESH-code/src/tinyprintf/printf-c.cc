...
static constexpr bool STRICT_COMPLIANCE     = false;
static constexpr bool SUPPORT_N_FORMAT      = false; // Whether to support %n format type
static constexpr bool SUPPORT_H_LENGTHS     = false; // Whether to support h and hh length modifiers
static constexpr bool SUPPORT_T_LENGTH      = false; // Whether to support t length modifier
static constexpr bool SUPPORT_J_LENGTH      = false; // Whether to support j length modifier
